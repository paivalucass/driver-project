...
module pcihellocore_mm_interconnect_0 (
	...
	wire  [115:0] leds_s1_agent_rf_source_data;                                           // leds_s1_agent:rf_source_data -> leds_s1_agent_rsp_fifo:in_data
	...
	wire  [115:0] leds_s1_agent_rsp_fifo_out_data;                                        // leds_s1_agent_rsp_fifo:out_data -> leds_s1_agent:rf_sink_data
	...
	wire  [114:0] leds_s1_agent_rp_data;                                                  // leds_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [114:0] ledg_s1_agent_rp_data;                                                  // ledg_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [114:0] leds_s1_burst_adapter_source0_data;                                     // leds_s1_burst_adapter:source0_data -> leds_s1_agent:cp_data
	...
	wire          router_005_src_valid;                                                   // router_005:src_valid -> leds_s1_rsp_width_adapter:in_valid
	wire  [114:0] router_005_src_data;                                                    // router_005:src_data -> leds_s1_rsp_width_adapter:in_data
	wire          router_005_src_ready;                                                   // leds_s1_rsp_width_adapter:in_ready -> router_005:src_ready
	wire    [8:0] router_005_src_channel;                                                 // router_005:src_channel -> leds_s1_rsp_width_adapter:in_channel
	wire          router_005_src_startofpacket;                                           // router_005:src_startofpacket -> leds_s1_rsp_width_adapter:in_startofpacket
	wire          router_005_src_endofpacket;                                             // router_005:src_endofpacket -> leds_s1_rsp_width_adapter:in_endofpacket
	wire          leds_s1_rsp_width_adapter_src_valid;                                    // leds_s1_rsp_width_adapter:out_valid -> rsp_demux_004:sink_valid
	wire  [150:0] leds_s1_rsp_width_adapter_src_data;                                     // leds_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	wire          leds_s1_rsp_width_adapter_src_ready;                                    // rsp_demux_004:sink_ready -> leds_s1_rsp_width_adapter:out_ready
	wire    [8:0] leds_s1_rsp_width_adapter_src_channel;                                  // leds_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	wire          leds_s1_rsp_width_adapter_src_startofpacket;                            // leds_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_004:sink_startofpacket
	wire          leds_s1_rsp_width_adapter_src_endofpacket;                              // leds_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_004:sink_endofpacket
	wire          router_006_src_valid;                                                   // router_006:src_valid -> ledg_s1_rsp_width_adapter:in_valid
	wire  [114:0] router_006_src_data;                                                    // router_006:src_data -> ledg_s1_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                   // ledg_s1_rsp_width_adapter:in_ready -> router_006:src_ready
	wire    [8:0] router_006_src_channel;                                                 // router_006:src_channel -> ledg_s1_rsp_width_adapter:in_channel
	wire          router_006_src_startofpacket;                                           // router_006:src_startofpacket -> ledg_s1_rsp_width_adapter:in_startofpacket
	wire          router_006_src_endofpacket;                                             // router_006:src_endofpacket -> ledg_s1_rsp_width_adapter:in_endofpacket
	wire          ledg_s1_rsp_width_adapter_src_valid;                                    // ledg_s1_rsp_width_adapter:out_valid -> rsp_demux_005:sink_valid
	wire  [150:0] ledg_s1_rsp_width_adapter_src_data;                                     // ledg_s1_rsp_width_adapter:out_data -> rsp_demux_005:sink_data
	wire          ledg_s1_rsp_width_adapter_src_ready;                                    // rsp_demux_005:sink_ready -> ledg_s1_rsp_width_adapter:out_ready
	wire    [8:0] ledg_s1_rsp_width_adapter_src_channel;                                  // ledg_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	wire          ledg_s1_rsp_width_adapter_src_startofpacket;                            // ledg_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_005:sink_startofpacket
	wire          ledg_s1_rsp_width_adapter_src_endofpacket;                              // ledg_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_005:sink_endofpacket
	...
	wire          cmd_mux_004_src_valid;                                                  // cmd_mux_004:src_valid -> leds_s1_cmd_width_adapter:in_valid
	wire  [150:0] cmd_mux_004_src_data;                                                   // cmd_mux_004:src_data -> leds_s1_cmd_width_adapter:in_data
	wire          cmd_mux_004_src_ready;                                                  // leds_s1_cmd_width_adapter:in_ready -> cmd_mux_004:src_ready
	wire    [8:0] cmd_mux_004_src_channel;                                                // cmd_mux_004:src_channel -> leds_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_004_src_startofpacket;                                          // cmd_mux_004:src_startofpacket -> leds_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                            // cmd_mux_004:src_endofpacket -> leds_s1_cmd_width_adapter:in_endofpacket
	wire          leds_s1_cmd_width_adapter_src_valid;                                    // leds_s1_cmd_width_adapter:out_valid -> leds_s1_burst_adapter:sink0_valid
	wire  [114:0] leds_s1_cmd_width_adapter_src_data;                                     // leds_s1_cmd_width_adapter:out_data -> leds_s1_burst_adapter:sink0_data
	wire          leds_s1_cmd_width_adapter_src_ready;                                    // leds_s1_burst_adapter:sink0_ready -> leds_s1_cmd_width_adapter:out_ready
	wire    [8:0] leds_s1_cmd_width_adapter_src_channel;                                  // leds_s1_cmd_width_adapter:out_channel -> leds_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_005_src_valid;                                                  // cmd_mux_005:src_valid -> ledg_s1_cmd_width_adapter:in_valid
	wire  [150:0] cmd_mux_005_src_data;                                                   // cmd_mux_005:src_data -> ledg_s1_cmd_width_adapter:in_data
	wire          cmd_mux_005_src_ready;                                                  // ledg_s1_cmd_width_adapter:in_ready -> cmd_mux_005:src_ready
	wire    [8:0] cmd_mux_005_src_channel;                                                // cmd_mux_005:src_channel -> ledg_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_005_src_startofpacket;                                          // cmd_mux_005:src_startofpacket -> ledg_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                            // cmd_mux_005:src_endofpacket -> ledg_s1_cmd_width_adapter:in_endofpacket
